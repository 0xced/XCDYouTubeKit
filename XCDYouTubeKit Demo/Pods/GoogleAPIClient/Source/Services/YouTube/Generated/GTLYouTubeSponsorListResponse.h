...
//
//  GTLYouTubeSponsorListResponse.h
//
...
@interface GTLYouTubeSponsorListResponse : GTLCollectionObject
...
@property (nonatomic, retain) NSArray *items;  // of GTLYouTubeSponsor
