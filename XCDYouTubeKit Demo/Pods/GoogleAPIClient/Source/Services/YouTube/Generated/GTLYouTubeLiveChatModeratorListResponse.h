...
//
//  GTLYouTubeLiveChatModeratorListResponse.h
//
...
@interface GTLYouTubeLiveChatModeratorListResponse : GTLCollectionObject
...
@property (nonatomic, retain) NSArray *items;  // of GTLYouTubeLiveChatModerator
