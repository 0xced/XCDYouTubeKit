...
//
//  GTLYouTubeFanFundingEventListResponse.m
//
...
@implementation GTLYouTubeFanFundingEventListResponse
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map = @{
    @"items" : [GTLYouTubeFanFundingEvent class]
  };
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"youtube#fanFundingEventListResponse"];
}
