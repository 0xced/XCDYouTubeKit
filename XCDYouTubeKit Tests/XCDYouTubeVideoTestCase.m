...
- (void)testUndeterminedCaptionLanguageCode {
	
	/*This video: https://www.youtube.com/watch?v=RgKAFK5djSk Contains an undertermined language code according to YouTube and should not be included in the `captionURLs` */
	
	NSBundle *testBundle = [NSBundle bundleForClass:[self class]];
	
	XCDYouTubeVideo *video = [[XCDYouTubeVideo alloc]initWithIdentifier:@"RgKAFK5djSk" info:[NSDictionary dictionaryWithContentsOfURL:[testBundle URLForResource:@"testInfo_undetermined_language_code" withExtension:@"plist"]] playerScript:nil response:nil error:nil];
